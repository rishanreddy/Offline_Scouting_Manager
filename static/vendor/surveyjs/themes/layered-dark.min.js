/*!
 * For license information please see themes/layered-dark.min.js.LICENSE.txt
 */
  ...
  typeof exports == "object" && typeof module < "u"
    ...
    : typeof define == "function" && define.amd
      ...
      : ((e = typeof globalThis < "u" ? globalThis : e || self),
        (e.SurveyTheme = e.SurveyTheme || {}),
        (e.SurveyTheme.LayeredDark = r()));
})(this, function () {
  "use strict";
  var e = {
    themeName: "layered",
    ...
    cssVariables: {
      ...
      "--sjs-shadow-inner":
        "0px 0px 0px 1px rgba(255, 255, 255, 0.03),inset 0px 1px 4px 0px rgba(0, 0, 0, 0.2)",
      "--sjs-shadow-inner-reset":
        "0px 0px 0px 0px rgba(255, 255, 255, 0.03),inset 0px 0px 0px 0px rgba(0, 0, 0, 0.2)",
